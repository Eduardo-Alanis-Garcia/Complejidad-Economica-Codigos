...
def espacio_nacional_red(datos, anio):
    # Crear el grafo
    ...
    fig = go.Figure(
        ...
        layout=go.Layout(
            title={
                "text": " Conexión de Estados <br><span style='font-size:14px;'> (Semestre " + anio + ") </span>",
                "x": 0.5,
                "xanchor": "center"
            },
            hovermode='closest',
    ...
    fig.update_layout(legend_title=dict(text="Región:"))
    return(fig)
